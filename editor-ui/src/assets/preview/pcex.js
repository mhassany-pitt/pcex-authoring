...
var pcex = {
  ...
  init: function () {
    ...
    if (pcex.currentGoal.fullyWorkedOut) {
      ...
      $('#goal_title').html("<img src='reader-24_white.png'>Example: " + pcex.currentGoal.name + "</img>");
    } else {
      pcex.activityType = 'ch';
      pcex.umApplicationId = 47;
      $('#goal_title').html("<img src='examination-24_white.png'>Challenge: " + pcex.currentGoal.name);
